...
import {TbFirma, TbFormatoCertificado, TbTipoParticipante} from "~shared/interfaces";
import {MatButton} from "@angular/material/button";
import {MatIcon} from "@angular/material/icon";
import {TbFormatoCertificadoService, TbTipoParticipanteService} from "app/services";
...
export class AsignarFormatoRegistroComponent implements OnInit {
  ...
  private _dialogRef: MatDialogRef<AsignarFormatoRegistroComponent> = inject(MatDialogRef<AsignarFormatoRegistroComponent>);
